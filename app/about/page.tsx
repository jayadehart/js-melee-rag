  ...
  return (
    <div className="flex flex-col items-center border-1 border-black bg-gray-50 h-full rounded-sm gap-8 p-8 ">
      ...
      <div>
        ...
        language models ability to answer questions about a specific subject or
        set of reference materials. You use the user&apos;s query to search your
        reference material, provide the query output to the LLM and have it
        generate a response based on that context. One of the most common query
        tools is a Vector Embedded Database. To start, you divide your reference
        material into a set of chunks, and store them with a vector array. From
        there, you can compare the vector coordinates of the query against your
        vector database. However, you can also use keyword searches, and you can
        even have LLMs generate SQL queries if you provide them the right tools.
      </div>
      ...
      <div>
        ...
        language for creating AI agents. They provide a graph based approach to
